...
Weather data is pulled from free Web APIs from openweathermap.org. To use the app, you would have to create an account with openweathermap.org and get the API key. Set the API key as an environment variable with name __OpenWeatherApiKey__
